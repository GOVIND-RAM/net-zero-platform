      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert, index) => (
            ...
            >
              <div className={`inline-flex p-4 rounded-2xl ${cert.iconBg} mb-6`}>
              ...
              <ul className="space-y-3 mb-8">
                {cert.features.map((feature, featureIndex) => (
                  <motion.li
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="w-2 h-2 bg-primary-emerald rounded-full flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="w-2 h-2 bg-primary-emerald rounded-full" />
