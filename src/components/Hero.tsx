...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-neutral-cream to-white flex items-center overflow-hidden">
      <div className="container-custom section-padding">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.div
              className="inline-flex items-center space-x-2 bg-primary-emerald/10 text-primary-emerald px-4 py-2 rounded-full text-sm font-medium"
            ...
            <motion.h1
              className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-neutral-charcoal leading-tight"
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-primary-emerald/20 to-accent-gold/20 rounded-3xl p-8 lg:p-12">
              ...
              <div className="relative h-64 bg-gradient-to-br from-primary-forest to-primary-emerald rounded-2xl flex items-center justify-center">
                <motion.div
                ...
                >
                  ...
                  <div className="text-xl font-semibold">Net Zero Journey</div>
                  <div className="text-sm opacity-90">Sustainable Future</div>
                </motion.div>
              </div>
            </div>
            ...
            {floatingCards.map((card, index) => (
              <motion.div
                key={card.text}
                className={`absolute bg-white rounded-xl shadow-lg p-3 lg:p-4 flex items-center space-x-2 lg:space-x-3 z-10 ${
