...
const DashboardSelection: React.FC = () => {
  ...
  return (
    <div className="dashboard-selection-page min-h-screen bg-slate-100">
      {/* Navbar */}
      <nav className="dashboard-selection-navbar bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
        <div className="dashboard-selection-navbar-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="dashboard-selection-navbar-content flex items-center justify-between h-16">
            ...
            <div className="dashboard-selection-logo flex items-center space-x-3">
              <div className="dashboard-selection-logo-icon bg-primary-emerald p-2 rounded-lg">
                <Award className="dashboard-selection-logo-award h-6 w-6 text-white" />
              </div>
              <span className="dashboard-selection-logo-text text-xl font-bold text-slate-900">EcoZero Certify</span>
            </div>
            ...
            <div className="dashboard-selection-user-menu relative">
              ...
              >
                <div className="dashboard-selection-user-avatar w-10 h-10 bg-primary-emerald rounded-full flex items-center justify-center text-white font-semibold">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          {/* Title */}
          <h1 className="dashboard-selection-title text-4xl font-bold text-slate-900 text-center mb-12">
            I want to pursue net zero certification for my
          </h1>

          {/* Certification Types Grid */}
          <div className="dashboard-selection-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
