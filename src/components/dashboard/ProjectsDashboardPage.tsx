...
const ProjectsDashboardPage: React.FC = () => {
  ...
  return (
    <MainLayout>
      <div className="projects-dashboard-page max-w-7xl mx-auto">
        <PageHeader
        ...
        {/* Stats Cards */}
        <div className="projects-dashboard-stats-grid grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="projects-dashboard-stat-card bg-white rounded-xl border border-slate-200 p-6 shadow-lg">
            <div className="projects-dashboard-stat-card-content flex items-center">
              <div className="projects-dashboard-stat-card-info flex-1">
                <p className="projects-dashboard-stat-card-label text-sm font-medium text-gray-600">Total Projects</p>
                <p className="projects-dashboard-stat-card-value text-3xl font-bold text-neutral-charcoal">{projects.length}</p>
              </div>
              <div className="projects-dashboard-stat-card-icon-container bg-primary-emerald/10 p-3 rounded-lg">
                <svg className="projects-dashboard-stat-card-icon h-6 w-6 text-primary-emerald" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="projects-dashboard-stat-card bg-white rounded-xl border border-slate-200 p-6 shadow-lg">
            <div className="projects-dashboard-stat-card-content flex items-center">
              <div className="projects-dashboard-stat-card-info flex-1">
                <p className="projects-dashboard-stat-card-label text-sm font-medium text-gray-600">Certified</p>
                <p className="projects-dashboard-stat-card-value text-3xl font-bold text-green-600">
                  {projects.filter(p => p.status === 'Certified').length}
                </p>
              </div>
              <div className="projects-dashboard-stat-card-icon-container bg-green-50 p-3 rounded-lg">
                <svg className="projects-dashboard-stat-card-icon h-6 w-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="projects-dashboard-stat-card bg-white rounded-xl border border-slate-200 p-6 shadow-lg">
            <div className="projects-dashboard-stat-card-content flex items-center">
              <div className="projects-dashboard-stat-card-info flex-1">
                <p className="projects-dashboard-stat-card-label text-sm font-medium text-gray-600">In Progress</p>
                <p className="projects-dashboard-stat-card-value text-3xl font-bold text-accent-gold">
                  {projects.filter(p => p.status === 'In Progress').length}
                </p>
              </div>
              <div className="projects-dashboard-stat-card-icon-container bg-accent-gold/10 p-3 rounded-lg">
                <svg className="projects-dashboard-stat-card-icon h-6 w-6 text-accent-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="projects-dashboard-stat-card bg-white rounded-xl border border-slate-200 p-6 shadow-lg">
            <div className="projects-dashboard-stat-card-content flex items-center">
              <div className="projects-dashboard-stat-card-info flex-1">
                <p className="projects-dashboard-stat-card-label text-sm font-medium text-gray-600">Pending Review</p>
                <p className="projects-dashboard-stat-card-value text-3xl font-bold text-blue-600">
                  {projects.filter(p => p.status === 'Pending Review').length}
                </p>
              </div>
              <div className="projects-dashboard-stat-card-icon-container bg-blue-50 p-3 rounded-lg">
                <svg className="projects-dashboard-stat-card-icon h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
