...
const SignupForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <h2 className="text-2xl font-bold text-neutral-charcoal mb-6">Create Account</h2>
      ...
      {/* Full Name */}
      <div>
        <label htmlFor="name" className="block text-neutral-charcoal text-sm font-medium mb-2">
          Full Name
        </label>
