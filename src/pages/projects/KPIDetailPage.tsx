    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={handleBack}
            className="px-6 py-3 bg-primary-emerald text-white rounded-lg hover:bg-primary-emerald/90 transition-colors"
          >
            Back to Overview
          </button>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-lg font-semibold text-primary-emerald">
        ...
        >
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              {currentQuestion?.points && (
                <div className="bg-primary-emerald/10 text-primary-emerald px-3 py-1 rounded-full text-sm font-medium">
            ...
            {currentQuestion?.description && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-blue-700 text-sm">{currentQuestion.description}</p>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="flex justify-between pt-6 border-t border-slate-200">
            <button
              ...
              className="px-6 py-3 text-slate-600 hover:text-slate-900 transition-colors font-medium disabled:text-slate-400 disabled:cursor-not-allowed"
            >
              ← Previous
            </button>
